...
function Footer() {
    return (
        <div className={`${styles.FooterMain}`}>
            ...
            <div className={`${styles.FooterBottom}`}><p>&copy; 2024 Indfab,All rights reserved. | Developed by <a href="https://www.linkedin.com/in/srinjoy-roy-161003251/">Srinjoy Roy</a></p>
